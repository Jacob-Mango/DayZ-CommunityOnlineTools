class EditorMenu extends UIScriptedMenu 
{
    ...
    {
        layoutRoot = GetGame().GetWorkspace().CreateWidgets( "COS\\Modules\\Editor\\gui\\layouts\\EditorMenu.layout" );
		...
		m_weatherMenu  		= GetGame().GetWorkspace().CreateWidgets( "COS\\Modules\\Editor\\gui\\layouts\\WeatherMenu.layout", layoutRoot );
		m_positionMenu 		= GetGame().GetWorkspace().CreateWidgets( "COS\\Modules\\Editor\\gui\\layouts\\PositionMenu.layout", layoutRoot );
		m_gameMenu 	   		= GetGame().GetWorkspace().CreateWidgets( "COS\\Modules\\Editor\\gui\\layouts\\GameMenu.layout", layoutRoot );
		m_objectInfoMenu 	= GetGame().GetWorkspace().CreateWidgets( "COS\\Modules\\Editor\\gui\\layouts\\ObjectEditorInfo.layout", layoutRoot );
		m_cameraMenu 		= GetGame().GetWorkspace().CreateWidgets( "COS\\Modules\\Editor\\gui\\layouts\\CameraSettings.layout", layoutRoot );
