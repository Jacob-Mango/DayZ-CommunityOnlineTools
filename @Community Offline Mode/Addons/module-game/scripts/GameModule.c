class GameModule: EditorModule
{
    ...
    void GameModule()
    {
        ...
        GetRPCManager().AddRPC( "COT_Game", "KillEntity", this, SingeplayerExecutionType.Server );

        GetRPCManager().AddRPC( "COT_Game", "SetOldAiming", this, SingeplayerExecutionType.Client );
        GetRPCManager().AddRPC( "COT_Game", "SetGodMode", this, SingeplayerExecutionType.Client );
    ...
    {
        return "COT/Modules/Game/layouts/GameMenu.layout";
    }
