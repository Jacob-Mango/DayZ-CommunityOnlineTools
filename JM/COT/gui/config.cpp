...
class RscMapControl
{
	...
	colorGrid[]={0.8,0.7,0,1}; //0.15000001,0.15000001,0.050000001,0.89999998
	colorGridMap[]={1,1,1,1}; //0.25,0.25,0.1,0.75
	fontNames="gui/fonts/MetronBlack16"; //Marker names
	sizeExNames=0.05; //Marker names
	colorNames[]={1,1,1,1};  //0,0,0,1
	fontGrid="gui/fonts/MetronBlack48"; //grid numbers
	sizeExGrid=0.02; //0099999998 Grid numbers size
	fontLevel="gui/fonts/MetronLight-Italic28";
	sizeExLevel=0.0099999998;
	colorMountPoint[]={0.44999999,0.40000001,0.25,1};
	mapPointDensity=5.5; //1.5
	text="";
