...
class RscMapControl
{
	...
	fontLabel = "gui/fonts/metronlight22";
	fontGrid = "gui/fonts/metronlight22";
	sizeExGrid = 0.03;
	fontUnits = "gui/fonts/metronlight22";
	fontNames = "gui/fonts/metronlight22";
	sizeExNames = 0.052;
	fontInfo = "gui/fonts/metronlight22";
	fontLevel = "gui/fonts/metronlight22";
