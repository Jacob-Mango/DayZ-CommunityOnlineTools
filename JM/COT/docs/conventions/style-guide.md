...
**Standard:** Always use `protected` visibility for the module reference (never `private`: a `modded class` in another mod cannot compile against a private member - see module-form-patterns.md, section 10).

```c
class JMMyForm: JMFormBase
{
    protected JMMyModule m_Module;  // Always protected
...
protected UIActionSlider m_HealthSlider;
protected UIActionCheckbox m_GodModeCheckbox;
protected UIActionEditableText m_PlayerNameInput;
protected UIActionSelectBox m_SpawnModeSelect;
protected UIActionScroller m_MainScroller;

// Avoid type prefixes
protected UIActionButton m_btn_Refresh;      // Don't use prefixes
protected UIActionSlider m_sldr_Health;      // Type is clear from declaration
protected UIActionCheckbox m_chkbx_GodMode;  // Less readable
```
...
class JMMyForm: JMFormBase
{
    // Module reference (always protected)
...
| `OnCreate()` | Once | Build all static UI elements |
...
{
    protected JMMyModule m_Module;
    protected ref MyButtonData m_TempData;  // Store data for confirmation
...
class JMExampleForm: JMFormBase
{
    ...
    protected UIActionScroller m_MainScroller;
    protected Widget m_ContentWrapper;
    protected Widget m_DynamicContent;
    
    protected UIActionButton m_RefreshButton;
    protected UIActionButton m_DeleteButton;
    protected UIActionEditableText m_SearchInput;
    protected UIActionSelectBox m_FilterSelect;
    
    protected ref MyButtonData m_TempData;
