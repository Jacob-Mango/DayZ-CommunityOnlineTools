...
- [Limitations](limitations.md) — layout-system quirks found while building COT
- [Widget Input & Localization](widget-input-localization.md) — `UIAction*` API details, input actions, stringtable
- [Tab Injection & Mod Extensibility](tab-injection-extensibility.md) — architectural goals and design patterns for adding custom tabs from sub-mods
...
*Last updated: 2026-09-21 (COT-specific pages re-checked against the code; vanilla reference pages unchanged)*
