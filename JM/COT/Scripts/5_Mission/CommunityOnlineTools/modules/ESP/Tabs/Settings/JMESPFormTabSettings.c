...
class JMESPFormTabSettings: JMFormTab
{
	...
	override void OnCreate( Widget panel )
	{
		...
		m_PlayerSkeletons = UIActionManager.CreateDropdown( displayContent, "#STR_COT_ESP_MODULE_DRAW_PLAYER_SKELETONS", panel, this, "OnChange_PlayerSkeletons", skeletonOpts );
		m_Form.AddOverlay( m_PlayerSkeletons );
	...
	protected void ApplySafetyStyle()
	{
	...
	protected void ApplyThicknessPreview()
	{
		if ( !m_SkeletonLineThickness )
			return;
