...
//! (m_ListWrapper/m_EditorWrapper on the form) and SetMode() tears down and
...
class JMRoleManagerFormTabRoles
{
	...
	void RebuildRoleList()
	{
		...
		UIActionButton createRoleBtn = UIActionManager.CreateButton( cardContent, "#STR_COT_ROLEMANAGER_MODULE_NEW_ROLE_BUTTON", this, "OnClick_CreateRole" );
	...
	void OnClick_CreateRole( UIEvent eid, UIActionBase action )
	{
		...
		m_Form.CreateConfirmation_Two( JMConfirmationType.EDIT, "#STR_COT_ROLEMANAGER_MODULE_CREATE_ROLE_TITLE", "#STR_COT_ROLEMANAGER_MODULE_CREATE_ROLE_BODY", "#STR_COT_GENERIC_CANCEL", "", "#STR_COT_GENERIC_CONFIRM", "OnCreateRole_Confirm" );
	}
	...
	void OnClick_DeleteRole( UIEvent eid, UIActionBase action )
	{
		...
		m_Form.CreateConfirmation_Two( JMConfirmationType.INFO, "#STR_COT_GENERIC_CONFIRM", delMsg, "#STR_COT_GENERIC_NO", "", "#STR_COT_GENERIC_YES", "OnDeleteRole_Confirm" );
	}
	...
	void OnClick_RenameRole( UIEvent eid, UIActionBase action )
	{
		...
		m_Form.CreateConfirmation_Two( JMConfirmationType.EDIT, renameTitle, renameBody, "#STR_COT_GENERIC_CANCEL", "", "#STR_COT_GENERIC_CONFIRM", "ConfirmRenameRole" );
	}
