...
class JMWeatherFormTabSky: JMFormTab
{
	...
	override void OnCreate( Widget panel )
	{
		...
		m_SliderDynamicFogDistance = UIActionManager.CreateSyncedSlider( fogBody, "#STR_COT_GENERIC_DISTANCE", 0, 1, this, "OnChange_Fog" );
		m_SliderDynamicFogDistance.SetStepValue( 0.01 );
		m_SliderDynamicFogDistance.SetTooltip( "#STR_COT_WEATHER_DYNFOG_DESC" );

		m_SliderDynamicFogHeight = UIActionManager.CreateSyncedSlider( fogBody, "#STR_COT_GENERIC_HEIGHT", 0, 1, this, "OnChange_Fog" );
		...
		m_SliderDynamicFogBias = UIActionManager.CreateSyncedSlider( fogBody, "#STR_COT_GENERIC_BIAS", -500, 500, this, "OnChange_Fog" );
		...
		m_SliderStormLightning = UIActionManager.CreateSyncedSlider( stormBody, "#STR_COT_WEATHER_LIGHTNING", 0, 120, this, "OnChange_Storm" );
		...
		m_SliderSandstormDuration = UIActionManager.CreateSyncedSlider( sandstormBody, "#STR_COT_WEATHER_SANDSTORM_DURATION", 0, 120, this, "OnChange_Sandstorm" );
		...
		m_SliderSandstormFadeIn = UIActionManager.CreateSyncedSlider( sandstormBody, "#STR_COT_WEATHER_SANDSTORM_FADEIN", 0, 120, this, "OnChange_Sandstorm" );
		...
		m_SliderSandstormWindMagnitude = UIActionManager.CreateSyncedSlider( sandstormBody, "#STR_COT_WEATHER_SANDSTORM_WINDMAGNITUDE", 18, JMWeatherForm.WIND_SCALE_MAX, this, "OnChange_Sandstorm" );
