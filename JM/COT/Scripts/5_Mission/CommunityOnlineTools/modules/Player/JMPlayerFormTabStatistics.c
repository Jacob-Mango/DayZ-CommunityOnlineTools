...
class JMPlayerFormTabStatistics
{
	...
	Widget Build( Widget actionsParent )
	{
		...
		m_StatsRefreshButton.SetFixedSize( JMFormBase.HEADER_ACTION_PX, JMFormBase.HEADER_ACTION_PX );
	...
	void OnSelectionChanged()
	{
		...
		if ( m_Form.IsTabActive( JMPlayerForm.TAB_STATISTICS ) )
			RequestStatistics();
		else
