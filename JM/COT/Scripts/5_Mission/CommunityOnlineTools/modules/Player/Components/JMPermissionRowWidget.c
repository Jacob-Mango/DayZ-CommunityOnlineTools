...
class JMPermissionRowWidget: COT_ScriptedWidgetEventHandler 
{
	...
	protected TextWidget m_txt_PermissionIndent;
	protected TextWidget m_txt_PermissionName;
	protected ref OptionSelectorMultistate m_state_Permission;
	...
	protected JMPermissionRowWidget Set( array<string> tokens, int depth, int type )
	{
