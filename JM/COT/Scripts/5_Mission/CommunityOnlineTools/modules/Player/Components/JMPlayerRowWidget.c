class JMPlayerRowWidget: COT_ScriptedWidgetEventHandler 
{
	...
	protected bool m_IsHeader;
	protected bool m_IsChecked;
	TextWidget Name;
	ButtonWidget Button;
	CheckBoxWidget Checkbox;
	protected Widget m_RowFill;
	protected Widget m_RowFocusBar;
	protected ButtonWidget m_ChevronButton;
	protected ImageWidget m_ChevronDown;
	protected ImageWidget m_ChevronRight;
	protected ButtonWidget m_CheckboxButton;
	protected ImageWidget m_CheckMark;
	protected Widget m_CheckBoxFill;
	protected ImageWidget m_BadgeFlagged;
	protected ImageWidget m_BadgeRole;
	protected ImageWidget m_BadgeDead;
	protected ImageWidget m_BadgeUncon;
	protected ImageWidget m_BadgeBrokenLeg;
	protected ImageWidget m_BadgeBleeding;
	protected ImageWidget m_BadgeSick;
	JMPlayerForm Menu;
	...
	protected float StackBadge( ImageWidget badge, float slot )
	{
	...
	protected string BadgeTooltip( Widget w )
	{
		if ( !w )
			return "";
