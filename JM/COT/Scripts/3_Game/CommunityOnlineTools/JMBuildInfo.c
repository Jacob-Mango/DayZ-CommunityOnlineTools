...
class JMBuildInfo
{
	...
	static const string VERSION = "0.8.100614";

	//! VERSION plus the channel suffix - what the UI shows.
	static const string DISPLAY_VERSION = "0.8.100614-internal";
	...
	static const string COMMIT = "ebb36ea1";
	...
	static const string BUILT_AT = "2026-09-17 22:09";
