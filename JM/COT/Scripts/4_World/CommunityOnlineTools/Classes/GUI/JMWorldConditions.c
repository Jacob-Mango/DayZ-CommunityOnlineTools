...
class JMWorldConditions
{
	...
	protected static const float SNOW_VISIBLE     = 0.10;
	//! Rain above this reads as rain rather than the odd stray drop.
	protected static const float RAIN_VISIBLE     = 0.10;
	...
	protected static const float RAIN_STORM       = 0.60;
	protected static const float OVERCAST_STORM   = 0.85;
	//! Fog thick enough to cut draw distance.
	protected static const float FOG_VISIBLE      = 0.30;
	//! Solid cloud lid vs. broken cloud.
	protected static const float OVERCAST_SOLID   = 0.65;
	protected static const float OVERCAST_BROKEN  = 0.30;

	// --- Time-of-day boundaries (24h) ---------------------------------------
	protected static const int HOUR_DAWN_START = 5;
	protected static const int HOUR_DAY_START  = 8;
	protected static const int HOUR_DUSK_START = 18;
	protected static const int HOUR_NIGHT_START = 21;
	...
	protected static float Soonest( float current, WeatherPhenomenon phenomenon )
	{
		if ( !phenomenon )
			return current;
	...
	protected static int ReadWeatherKind( bool forecast )
	{
		Weather weather = g_Game.GetWeather();
		if ( !weather )
	...
	protected static float ReadPhenomenon( WeatherPhenomenon phenomenon, bool forecast )
	{
		if ( !phenomenon )
			return 0;
