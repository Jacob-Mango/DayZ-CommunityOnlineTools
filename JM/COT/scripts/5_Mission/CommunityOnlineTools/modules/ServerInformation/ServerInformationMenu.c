class ServerInformationMenu extends Form
{
	...
	void ServerInformationMenu()
	{
		ServerInformationModule.DATA_UPDATED.Insert( UpdateData );
	}

	void ~ServerInformationMenu()
	{
		ServerInformationModule.DATA_UPDATED.Remove( UpdateData );
	}
