...
{
	ref array< ref TeleportLocation > Locations;

	void TeleportSettings()
	{
		Locations = new ref array< ref TeleportLocation >;
	}
	...
	{
		Locations.Insert( new ref TeleportLocation( name, position, radius ) );
	}
